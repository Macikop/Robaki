        ...
        case(state)
            ...
            IDLE: begin
                ...
                if (start_check) begin
                    terrain_address_nxt = ADDR_W'((pos_y + points_y[0]) * TERRAIN_WIDTH + (pos_x + points_x[0]));
            ...
            RUNNING: begin
                if (ram_client.request && ram_client.granted) begin
                    ...
                    if (requests_sent + 1 < NUM_POINTS) begin
                        ...
                        terrain_address_nxt = ADDR_W'((pos_y + points_y[requests_sent_nxt[2:0]]) * TERRAIN_WIDTH + (pos_x + points_x[requests_sent_nxt[2:0]]));
                        ram_request_nxt     = 1'b1;
                    end else begin
                        requests_sent_nxt   = requests_sent + 1;
                        ram_request_nxt     = 1'b0;
